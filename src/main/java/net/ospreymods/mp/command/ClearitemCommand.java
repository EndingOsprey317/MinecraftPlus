...
package net.ospreymods.mp.command;

import net.ospreymods.mp.procedures.Clearitem_ProcedureProcedure;
...
public class ClearitemCommand extends MpModElements.ModElement {
	...
	private LiteralArgumentBuilder<CommandSource> customCommand() {
		return LiteralArgumentBuilder.<CommandSource>literal("clearitem").requires(s -> s.hasPermissionLevel(2))
	...
	private int execute(CommandContext<CommandSource> ctx) {
		...
		});
		{
			...
			Clearitem_ProcedureProcedure.executeProcedure($_dependencies);
		}
		return 0;
	}
}
