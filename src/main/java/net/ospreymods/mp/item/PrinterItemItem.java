...
public class PrinterItemItem extends MpModElements.ModElement {
	@ObjectHolder("mp:printer_item")
	public static final Item block = null;
	public PrinterItemItem(MpModElements instance) {
		super(instance, 137);
	}
