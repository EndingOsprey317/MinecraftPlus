...
import net.ospreymods.mp.procedures.EnderStaffFindPositionProcedure;
import net.ospreymods.mp.itemgroup.MincraftPlusTabItemsItemGroup;
import net.ospreymods.mp.gui.EnderStaffGuiGui;
...
public class EnderStaffItem extends MpModElements.ModElement {
	@ObjectHolder("mp:ender_staff")
	public static final Item block = null;
	public EnderStaffItem(MpModElements instance) {
		super(instance, 5);
	...
	public void onItemDropped(ItemTossEvent event) {
		if (event.getEntityItem().getItem().getItem() == block) {
			if (Minecraft.getInstance().currentScreen instanceof EnderStaffGuiGui.GuiWindow) {
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			super(new Item.Properties().group(MincraftPlusTabItemsItemGroup.tab).maxStackSize(1).rarity(Rarity.COMMON));
			setRegistryName("ender_staff");
		}
		...
		public ActionResult<ItemStack> onItemRightClick(World world, PlayerEntity entity, Hand hand) {
			...
			if (entity instanceof ServerPlayerEntity) {
				NetworkHooks.openGui((ServerPlayerEntity) entity, new INamedContainerProvider() {
					...
					public ITextComponent getDisplayName() {
						return new StringTextComponent("Ender Staff");
					}
					...
					public Container createMenu(int id, PlayerInventory inventory, PlayerEntity player) {
						...
						return new EnderStaffGuiGui.GuiContainerMod(id, inventory, packetBuffer);
					}
				}, buf -> {
			...
			}
			{
				...
				EnderStaffFindPositionProcedure.executeProcedure($_dependencies);
			}
			return ar;
		}
