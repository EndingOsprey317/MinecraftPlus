...
public class MilkChocolateItem extends MpModElements.ModElement {
	@ObjectHolder("mp:milk_chocolate")
	public static final Item block = null;
	public MilkChocolateItem(MpModElements instance) {
		super(instance, 11);
	}
	...
	public static class FoodItemCustom extends Item {
		public FoodItemCustom() {
			super(new Item.Properties().group(MincraftPlusTabItemsItemGroup.tab).maxStackSize(64).rarity(Rarity.COMMON)
					.food((new Food.Builder()).hunger(4).saturation(0f).build()));
